<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="TipoInterconsulta.aspx.cs" Inherits="Portal.Views.Interconsultas.TipoInterconsulta" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">TIPO INTERCONSULTA | SOLUGLOB IKON</asp:Content>
...
<asp:Content runat="server" ID="ContectPageLevelScripts" ContentPlaceHolderID="PageLevelScripts">
    ...
    <script src="/Assets/pages/scripts/Interconsultas/AjaxInterConsultas.js"></script>
</asp:Content>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">TIPO INTERCONSULTAS</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange ReloadDataTable" data-date-format="dd/mm/yyyy">
                                            <input type="text" id="dprFromTipInter" class="form-control" name="dprFromTipInter" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("dd/MM/yyyy") %>">
                                            <span class="input-group-addon"> al </span>
                                            <input type="text" id="dprToTipInter" class="form-control" name="dprToTipInter" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") %>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="cmbTipInter" class="form-control select2me ReloadDataTable">
                                            <option value="">Select...</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group" id="divProfesional" hidden="hidden">
                                    <label class="control-label col-md-3">PROFESIONAL:</label>
                                    <div class="col-md-9">
                                        <select id="cmbProfesional" class="form-control select2me ReloadDataTable">
                                            <option value="">Select...</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableTipoInter" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th style="width:10%; text-align: center; vertical-align:middle">CLASE</th>
                                            ...
                                            <th style="width:10%; text-align: center; vertical-align:middle">ESPE. TICKET</th>
                                            ...
                                            <th style="width:10%; text-align: center; vertical-align:middle">AUTORIZADO</th>
                                        </tr>
                                    </thead>
