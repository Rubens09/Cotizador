<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="CargaDetalleEstudioV2.aspx.cs" Inherits="Portal.Views.Estudios.CargaDetalleEstudioV2" %>
                        ...
                        <div class="row">
                            <div class=" col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <select id="cmbLab" class="form-control select2me" disabled>
                                            <option value="">Select...</option>
                                        </select>
                                        </div>
                                      <label class="control-label col-md-1">#SOLICITUD:</label>
                                    <div class="col-md-3">
                                        <select id="NumChopo" class="form-control select2me" disabled>
                                            <option value="">Select...</option>
                                        </select>
                                        </div>
                                ...
                                <table id="TableCargaDetalleNimbo" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:55%; text-align: center; vertical-align:middle">DESCRIPCION</th>
    ...
    <div class="modal-dialog" id="mdialTamanio">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Detalle Carga Solicitud Estudios</h4>
            </div>
                ...
                <div class=" col-md-12">
                    ...
                    <div class="col-md-12" style="text-align:center">
                        ...
                        <table id="TableVerCargaDetalleNimbo" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th style="width:20%; text-align: center; vertical-align:middle">NUMNIMBO</th>
                                    ...
                                    <th style="width:10%; text-align: center; vertical-align:middle">LABORATORIO</th>
