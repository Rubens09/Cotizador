<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="ReporteInterconsultas.aspx.cs" Inherits="Portal.Views.Reportes.ReporteInterconsultas" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">REPORTES INTERCONSULTAS | SOLUGLOB IKON</asp:Content>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">REPORTES INTERCONSULTA</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                    <div class="table-toolbar">
                        <div class="row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange" data-date-format="dd/mm/yyyy">
                                            <input type="text" id="dprFromInterconsulta" class="form-control" name="dprFromInterconsulta" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("dd/MM/yyyy") %>">
                                            <span class="input-group-addon"> al </span>
                                            <input type="text" id="dprToInterconsulta" class="form-control" name="dprToInterconsulta" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") %>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-md-3">
                                <input type="button" class="btn green pull-right" onclick="PreparaCargaInterconsulta()" value="Cargar">
                              <br /><br />
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableReporteInterconsulta" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:10%; text-align: center; vertical-align:middle">FECHA CORTE</th>
                                        </tr>
                                    </thead>
