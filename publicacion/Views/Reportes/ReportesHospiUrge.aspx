<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="ReportesHospiUrge.aspx.cs" Inherits="Portal.Views.Reportes.ReportesHospiUrge" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">REPORTES HOSPITALIZADOS / URGENCIAS | SOLUGLOB IKON</asp:Content>
...
<asp:Content runat="server" ID="ContectPageLevelScripts" ContentPlaceHolderID="PageLevelScripts">
    ...
    CargaSelect($("#TipoRepHospUrg"), "GetTipoHospUrg");
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">REPORTES HOSPITALIZADOS / URGENCIAS</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                    <div class="table-toolbar">
                        <div class="row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange" data-date-format="dd/mm/yyyy">
                                            <input type="text" id="dprFromHospUrg" class="form-control" name="dprFromHospUrg" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("dd/MM/yyyy") %>">
                                            <span class="input-group-addon"> al </span>
                                            <input type="text" id="dprToHospUrg" class="form-control" name="dprToHospUrg" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") %>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="TipoRepHospUrg" class="form-control select2me">
                          ...
                          <div class="col-md-3">
                                <input type="button" class="btn green pull-right" onclick="PreparaCargaHospUrg()" value="Cargar">
                              <br /><br />
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableHospUrg" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:10%; text-align: center; vertical-align:middle">HOPSITAL</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">EPISODIO</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">INGRESO</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">EGRESO</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">PARENTESCO</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">T. PACIENTE</th>
                                            ...
                                            <th style="width:10%; text-align: center; vertical-align:middle">DIAGNOSTICO</th>
                                        </tr>
                                    </thead>
