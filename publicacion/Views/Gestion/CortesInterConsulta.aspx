<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="CortesInterConsulta.aspx.cs" Inherits="Portal.Views.Gestion.CortesInterConsulta" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">CORTES INTERCONSULTA | SOLUGLOB IKON</asp:Content>
...
<asp:Content runat="server" ID="ContectPageLevelScripts" ContentPlaceHolderID="PageLevelScripts">
    ...
    <script src="/Assets/pages/scripts/Gestion/OperacionesInterconsulta.js"></script>
    <script>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">CORTES INTERCONSULTA</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                    <div class="table-toolbar">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange" data-date-format="dd/mm/yyyy">
                                            <input type="text" id="dprFromCorteInterconsulta" class="form-control" name="dprFromCorteInterconsulta" onchange="PreparaCargaInter();" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("dd/MM/yyyy") %>">
                                            <span class="input-group-addon"> al </span>
                                            <input type="text" id="dprToCorteInterconsulta" class="form-control" name="dprToCorteInterconsulta" onchange="PreparaCargaInter();" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") %>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange1" class="input-group date-picker input-daterange" data-date-format="dd/mm/yyyy">
                                            <input type="text" id="dprInterConsultaCorte" class="form-control" name="dprFromInterconsultaCorte" value="<%= DateTime.Now.ToString("dd/MM/yyyy") %>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-md-3">
                              ...
                              <br /><br />
                               <input type="button" class="btn green pull-right" value="Guardar Corte" id="btnGuardaFcorte" name="GuardaFechasCorte" onclick="GuardadoCorte();">
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableCortesInter" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:25%; text-align: center; vertical-align:middle">MEDICO</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">FECHA INTER.</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">TIPO INTER</th>
                                            <th></th>
