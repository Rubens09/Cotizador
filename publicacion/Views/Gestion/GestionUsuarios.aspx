<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestionUsuarios.aspx.cs" Inherits="Portal.Views.Gestion.GestionUsuarios" %>
                        ...
                        <div class="row">
                            <div class=" col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="GestEspeId" class="form-control select2me">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="GestMedId" class="form-control select2me">
                                            <option value="">Select...</option>
                                        </select>
                                    </div>
                                </div>
                          ...
                          <div class="col-md-3">
                                <input type="button" class="btn green pull-right" value="Alta" onclick="AltaMedico()">
                              <br /><br />
                                ...
                                <table id="TableGesMedicos" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:20%; text-align: center; vertical-align:middle">NOMBRE</th>
