...
{
    var NameTable, ddlNomPaciente,ddlPermiso;
    var IsRequest = false;
    ...
    var a=function(IdControl, ReloadTable)
    {
        ...
        {
            IsRequest = true;
            if (document.getElementById("pacienteId") && (IdControl == "dpRange")) {
            ...
            if ((ddlPermiso == "1") || (ddlPermiso == "2") || (ddlPermiso == "3") || (ddlPermiso == "6") || (ddlPermiso == "9"))
            {
                $("#btnVerIngreso").hide();
                $("#btnIngreso").hide();
            }
        ...
        b = function (Command, IdControl, ReloadTable)
    {
        switch(Command) {
            case "Initialize":
                if (document.getElementById("pacienteId") && ((IdControl == "dpRange"))) {
                    c("GetPaciente", $("#pacienteId"), IdControl, ReloadTable);
                }
                else {
                    b("GetPaciente", IdControl, ReloadTable);
                }
                break;
            case "GetPaciente":
                ddlNomPaciente = document.getElementById("pacienteId") ? $("#pacienteId").val() : null;
                if (ReloadTable == 1) {

                    var DataColums = [{ data: "Afiliacion" }, { data: "Nombre" }, { data: "Sexo" }, { data: "Fnacimiento" }, { data: "Parentesco" }, { data: "TipoPac" }];
                    d("GetPadron", $("#TablePaciente"), DataColums, 3);
    ...
    d=function(Command, Control, DataColumns, NumColumn)
    {
        ...
        Control.DataTable({
            ...
            ajax:
            {
                ...
                dataSrc: "d",
                data: function (data) {
                    return JSON.stringify({ "NombreTabla": NameTable,"NombrePac":ddlNomPaciente });
                }
            },
            columns: DataColumns,
            dom: domin,
