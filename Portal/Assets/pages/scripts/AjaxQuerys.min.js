...
{
    var NameTable, ddlIDRegion, ddlTracto, ddlCaja, ddlCliente, ddlEstatus, ddlPermiso;
    var IsRequest = false;
    ...
    var a=function(IdControl, ReloadTable)
    {
        ...
        {
            IsRequest = true;
            if (document.getElementById("RegionID") && (IdControl == "dpRange") ) {
                $("#RegionID").select2("val", "");
            }
            if (document.getElementById("TractoId") && (IdControl == "dpRange") || (IdControl == "RegionID")) {
                $("#TractoId").select2("val", "");
            }
            if (document.getElementById("CajaId") && (IdControl == "dpRange") || (IdControl == "RegionID") || (IdControl == "TractoId")) {
                $("#CajaId").select2("val", "");
            }
            if (document.getElementById("ClienteId") && (IdControl == "dpRange") || (IdControl == "RegionID") || (IdControl == "TractoId") || (IdControl == "CajaId")) {
                $("#ClienteId").select2("val", "");
            }
            if (document.getElementById("EstatusId") && (IdControl == "dpRange") || (IdControl == "RegionID") || (IdControl == "TractoId") || (IdControl == "CajaId") || (IdControl == "ClienteId")) {
            ...
            if (ddlPermiso != "0")
            {
                document.getElementById("RegionID").setAttribute("disabled", "disabled");
        ...
        b = function (Command, IdControl, ReloadTable)
    {
        switch(Command) {
            case "Initialize":
                if (document.getElementById("RegionID") && ((IdControl == "dpRange") && (ddlPermiso=="0")))
                {
                    c("GetRegionIndex", $("#RegionID"), IdControl, ReloadTable);
                }
                else
                {
                    b("GetRegionIndex", IdControl, ReloadTable);
                }
                break;
            case "GetRegionIndex":
                ...
                if (document.getElementById("TractoId") && ((IdControl == "dpRange") || (IdControl =="RegionID")))
                {
                    c("GetTractoIndex", $("#TractoId"), IdControl, ReloadTable);
                }
                else
                {
                    b("GetTractoIndex", IdControl, ReloadTable);
                }
                break;

            case "GetTractoIndex":
               
                ddlTracto = document.getElementById("TractoId") ? $("#TractoId").val() : null;

                if (document.getElementById("CajaId") && ((IdControl == "dpRange") || (IdControl == "RegionID") || (IdControl == "TractoId") )) {
                    c("GetCajaIndex", $("#CajaId"), IdControl, ReloadTable);
                }
                else {
                    b("GetCajaIndex", IdControl, ReloadTable);
                }
                break;

            case "GetCajaIndex":

                ddlCaja = document.getElementById("CajaId") ? $("#CajaId").val() : null;

                if (document.getElementById("ClienteId") && ((IdControl == "dpRange") || (IdControl == "RegionID") || (IdControl == "TractoId") || (IdControl == "CajaId") )) {
                    c("GetClienteIndex", $("#ClienteId"), IdControl, ReloadTable);
                }
                else {
                    b("GetClienteIndex", IdControl, ReloadTable);
                }
                break;
            case "GetClienteIndex":
               
                ddlCliente = document.getElementById("ClienteId") ? $("#ClienteId").val() : null;

                if (document.getElementById("EstatusId") && ((IdControl == "dpRange") || (IdControl == "RegionID") || (IdControl == "TractoId") || (IdControl == "CajaId") || (IdControl == "ClienteId"))) {
                    c("GetEstatusIndex", $("#EstatusId"), IdControl, ReloadTable);
                }
                else {
                    b("GetEstatusIndex", IdControl, ReloadTable);
                }
                break;
            case "GetEstatusIndex":
                ddlEstatus = document.getElementById("EstatusId") ? $("#EstatusId").val() : null;

                if (ReloadTable == 1) {

                    var DataColums = [{ data: "Region" }, { data: "DocNum" }, { data: "IDTracto" }, { data: "IDCaja" }, { data: "Cliente" }, { data: "Origen" }, { data: "Destino" }, { data: "EstatusRelacion" }];
                    d("GetIndex", $("#TableEstatusTractos"), DataColums, 7);
        ...
        c = function (Command, Control, IdControl, ReloadTable)
    {
        ...
        $.ajax({
            ...
            data: JSON.stringify({ "IDRegion": ddlIDRegion, "IDTracto": ddlTracto, "IDCaja": ddlCaja, "IDCliente": ddlCliente, "Estatus": ddlEstatus }),
    ...
    d=function(Command, Control, DataColumns, NumColumn)
    {
        ...
        Control.DataTable({
            ...
            ajax:
            {
                ...
                dataSrc: "d",
                data: function (data) {
                    return JSON.stringify({ "IDRegion": ddlIDRegion, "IDTracto": ddlTracto, "IDCaja": ddlCaja, "IDCliente": ddlCliente, "Estatus": ddlEstatus });
                }
            },
            columns: DataColumns,
            dom: domin,
