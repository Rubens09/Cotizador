...
function AltaCatMedicos() {
    var cedula, nombre, telefono, recados, especialidad, email, direccion, activo, tipo, horario,Region;
    cedula = null;
    nombre = null;
    telefono = null;
    recados = null;
    ...
    Region = document.getElementById("RegiondAltaMed") ? $("#RegiondAltaMed").val() : null;

    if ((cedula != "") && (nombre != "") && (telefono != "") && (especialidad != "") && (direccion != "") && (email != "") && (tipo!="") && (Region!=""))
    {
        App.blockUI({ target: "#Entradas_Portlet", boxed: !0, message: "Procesando…" });
        ...
        $.ajax({
            ...
            data: JSON.stringify({ "cedula": cedula, "nombre": nombre, "telefono": telefono, "recados": recados, "especialidad": especialidad, "email": email, "direccion": direccion, "activo": activo,"tipomed": tipo,"Horario":horario,"Region": Region }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
