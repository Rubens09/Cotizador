...
<asp:Content ID="ContentPageLevelScripts" ContentPlaceHolderID="PageLevelScripts" runat="server">
    ...
    <script type="text/javascript"> 
        ...
        {
            var RegionSelect = "";
            RegionSelect = document.getElementById("cmbRegion") ? $("#cmbRegion").val() : null;
            document.getElementById("RegionSelect").value = RegionSelect;
        }
    </script>
    ...
    <div class="content">
        ...
        <form class="login-form" method="post" runat="server">
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn red pull-right">Iniciar sesión</button>
            </div>
        </form>
        <!-- END LOGIN FORM -->
    </div>
