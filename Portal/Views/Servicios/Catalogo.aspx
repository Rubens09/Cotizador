<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="Catalogo.aspx.cs" Inherits="Portal.Views.Servicios.Catalogo" %>

<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">CATALOGO | SOLUGLOB IKON</asp:Content>
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="PageLevelScripts">
    ...
    <script src="/Assets/pages/scripts/components-select2.min.js" type="text/javascript"></script>
    <script src="/Assets/pages/scripts/AjaxQuerys.Cat.js"></script>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">CATALOGO DE MEDICAMENTOS</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                   <div class="table-toolbar">
                        <div class="row">
                            <div class=" col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="claveCatId" class="form-control select2me ReloadDataTable">
                                            <option value="">Select...</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">AACTIVO:</label>
                                    <div class="col-md-9">
                                        <select id="activoCatId" class="form-control select2me ReloadDataTable">
                                            <option value="">Select...</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div id="Contenedor" class="table-container" style="position:relative;">
                        ...
                        <table id="TableCatalogo" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th style="width:30%; text-align: center; vertical-align:middle">CLAVE</th>
                                    <th style="width:30%; text-align: center; vertical-align:middle">ACTIVO</th>
