<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="ReportesCirugia.aspx.cs" Inherits="Portal.Views.Reportes.ReportesCirugia" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">REPORTES CIRUGIAS | SOLUGLOB IKON</asp:Content>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">REPORTES CIRUGIAS</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                    <div class="table-toolbar">
                        <div class="row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange" data-date-format="dd/mm/yyyy">
                                            <input type="text" id="dprFromCirugias" class="form-control" name="dprFromCirugias" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("dd/MM/yyyy") %>">
                                            <span class="input-group-addon"> al </span>
                                            <input type="text" id="dprToCirugias" class="form-control" name="dprToCirugias" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") %>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-md-3">
                                <input type="button" class="btn green pull-right" onclick="PreparaCargaCirugias()" value="Cargar">
                              <br /><br />
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableReporteCirugia" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th style="width:5%; text-align: center; vertical-align:middle">EXP</th>
                                            ...
                                            <th style="width:5%; text-align: center; vertical-align:middle">EPI</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">MOTIVO</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">DIAG</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">CPT</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">CIRUGIA</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">DESC</th>
                                            ...
                                            <th style="width:5%; text-align: center; vertical-align:middle">F.CORTE</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">MONTO</th>
                                        </tr>
                                    </thead>
