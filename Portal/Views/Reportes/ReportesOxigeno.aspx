<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="ReportesOxigeno.aspx.cs" Inherits="Portal.Views.Reportes.ReportesOxigeno" %>

<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">REPORTES SURTIMIENTO OXIGENO | SOLUGLOB IKON</asp:Content>
...
<asp:Content runat="server" ID="ContectPageLevelScripts" ContentPlaceHolderID="PageLevelScripts">
    ...
    <script>window.onload = function () {
        CargaSelect($("#TipoRepOxi"), "GetTipoSurtOxigeno");
        }
    </script>
</asp:Content>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">REPORTES SURTIDO OXIGENO</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                    <div class="table-toolbar">
                        <div class="row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange" data-date-format="dd/mm/yyyy">
                                            <input type="text" id="dprFromRepOxi" class="form-control" name="dprFromRepOxi" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("dd/MM/yyyy") %>">
                                            <span class="input-group-addon"> al </span>
                                            <input type="text" id="dprToRepOxi" class="form-control" name="dprToRepOxi" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") %>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="TipoRepOxi" class="form-control select2me">
                          ...
                          <div class="col-md-3">
                                <input type="button" class="btn green pull-right" onclick="PreparaCargaOxi()" value="Cargar">
                              <br /><br />
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableReporteRepOxi" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th style="width:20%; text-align: center; vertical-align:middle">EXPEDIENTE</th>
                                            <th style="width:40%; text-align: center; vertical-align:middle">PACIENTE</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">INICIO</th>
