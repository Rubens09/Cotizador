<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="ReporteRelacionChopo.aspx.cs" Inherits="Portal.Views.Reportes.ReporteRelacionChopo" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">REPORTES RELACION CHOPO | SOLUGLOB IKON</asp:Content>
...
<asp:Content runat="server" ID="ContectPageLevelScripts" ContentPlaceHolderID="PageLevelScripts">
    ...
    <script src="/Assets/pages/scripts/Estudios/AjaxReporteRelacionNimbo.js"></script>
</asp:Content>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">REPORTES RELACION CHOPO</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                        ...
                        <div class="row">
                            <div class=" col-md-8">
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange ReloadFilter" data-date-format="dd/mm/yyyy">
                                            <input type="text" id="dprFromChopo" class="form-control" name="dprFromChopo" value="<%= DateTime.Now.ToString("dd/MM/yyyy") %>">
                                            <span class="input-group-addon"> al </span>
                                            <input type="text" id="dprToChopo" class="form-control" name="dprToChopo" value="<%= DateTime.Now.ToString("dd/MM/yyyy") %>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableReporteRelacionChopo" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:5%; text-align: center; vertical-align:middle">FECHA V.</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">#NIMBO</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">SOLICITUD</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">ORDEN</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">CLAVE MAL</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">LAB</th>
                                        </tr>
                                    </thead>
