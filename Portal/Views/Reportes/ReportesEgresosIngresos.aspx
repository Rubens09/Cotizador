<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="ReportesEgresosIngresos.aspx.cs" Inherits="Portal.Views.Reportes.ReportesEgresosIngresos" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">REPORTES EGRESOS / INGRESOS | SOLUGLOB IKON</asp:Content>
...
<asp:Content runat="server" ID="ContectPageLevelScripts" ContentPlaceHolderID="PageLevelScripts">
    ...
    <script src="/Assets/pages/scripts/Reportes/CargaReportes.js"></script>
    <script src="/Assets/pages/scripts/Reportes/CargaDataTables.js"></script>
    <script>window.onload = function () {
    CargaSelect($("#RegRepInEgId"), "GetRegionIngresoEgreso");
    CargaSelect($("#TipoRepInEgId"), "GetTipoIngresoEgreso");
        }
    </script>
</asp:Content>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">REPORTES EGRESOS / INGRESOS</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                        ...
                        <div class="row">
                            <div class=" col-md-8">
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange" data-date-format="dd/mm/yyyy">
                                            <input type="text" id="dprFromIngEg" class="form-control" name="dprFromIngEg" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("dd/MM/yyyy") %>">
                                            <span class="input-group-addon"> al </span>
                                            <input type="text" id="dprToIngEg" class="form-control" name="dprToIngEg" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") %>">
                                        </div>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="RegRepInEgId" class="form-control select2me">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="TipoRepInEgId" class="form-control select2me">
                                            <option value="">Select...</option>
                                        </select>
                                    </div>
                                </div>
                          ...
                          <div class="col-md-3">
                                <input type="button" class="btn green pull-right" onclick="PreparaCarga()" value="Cargar">
                              <br /><br />
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableReporteIE" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th style="width:10%; text-align: center; vertical-align:middle">EXPEDIENTE</th>
                                            ...
                                            <th style="width:10%; text-align: center; vertical-align:middle">INGRESO</th>
                                            <th style="width:10%; text-align: center; vertical-align:middle">EGRESO</th>
                                            ...
                                            <th style="width:5%; text-align: center; vertical-align:middle">HOSPITAL</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">TIPO</th>
                                            <th style="width:5%; text-align: center; vertical-align:middle">REGION</th>
                                        </tr>
                                    </thead>
