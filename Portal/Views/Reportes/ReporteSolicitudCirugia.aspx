...
<script src="/Assets/pages/scripts/SolCirugias/OperacionesSolCirugias.js"></script>
        <script>
            ...
            {
                var DataColums = [{ data: "Solicitud" }, { data: "Afilia" }, { data: "Paciente" }, { data: "TipoPaciente" }, { data: "Medico" }, { data: "Diagnostico" }, { data: "FE" }, { data: "Hospital" }, {data:"Estatus"}];
                CargaCabeceroSolCir("GetTableCabSolCir", $("#TableSolicitudCir"),DataColums,8);
            }
                        ...
                        <table id="TableSolicitudCir" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:10%; text-align: center; vertical-align:middle">AFILIA</th>
