<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="AgregaNotaMédica.aspx.cs" Inherits="Portal.Views.Gestion.AgregaNotaMédica" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">NOTA MEDICA | SOLUGLOB IKON</asp:Content>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">Nota Médica</span>
                </div>
            </div>
                        ...
                        <div class="row">
                           <div class=" col-md-12">
                                <div class="form-group">
                                    <h3>Nota Médica</h3>
                                    <div class="col-md-12">
                                       <textarea id="txtNotaMedica" class="form-control" name="txtNotaMedica" style="height:125px"></textarea>
                                    </div>
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-md-8">
                                       <input id="txtArchivosEvidencias" class="form-control" type="text" name="txtArchivosEvidencias" value="" readonly /> 
                                   </div>
                                   <div class="col-md-1">
                                       <input type="button" id="btnBuscarEvidencia" name="btnBuscarEvidencia" class="btn gray" value="..." onclick="" />
                                   </div>
                               </div>
                            ...
                            <div class="col-md-4">
                                <center>
                                    <input type="button" id="btnPendiente" name="btnPendiente" class="btn blue" value="Pendiente" onclick="" />
