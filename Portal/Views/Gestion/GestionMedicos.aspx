<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="GestionMedicos.aspx.cs" Inherits="Portal.Views.Gestion.GestionMedicos" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">GESTION DE MEDICOS | SOLUGLOB IKON</asp:Content>
...
<asp:Content runat="server" ID="ContectPageLevelScripts" ContentPlaceHolderID="PageLevelScripts">
    ...
    <script src="/Assets/pages/scripts/Gestion/CargaDataMedicos.js"></script>
    <script src="/Assets/pages/scripts/Gestion/CargasMedicos.js"></script>
    <script>
        window.onload = function () {
            CargaSelect("GetCatEspecialidadMed", $("#EspecialidadAltaMed"));
            CargaSelect("GetCatTipo", $("#TipoMedico"));
            CargaSelect("GetCatRegionMed", $("#RegiondAltaMed"));
            var permiso = '<%= Session["Permiso"] %>';
            if (permiso == "6" || permiso=="5")
            {
                $("#altaMedMed").hide();
            }
        }
        $('#TableGesMedicos tbody').on('click', 'tr', function (e) {
            e.preventDefault();
            var renglon = $(this);
            ...
            if (permiso != "6") {
                $('.modal-body').load('content.html', function () {
                    ...
                    document.getElementById("txtHorario").setAttribute("readonly", "readonly");
                    document.getElementById("RegiondAltaMed").setAttribute("disabled", "disabled");
        ...
        function AltaMedico() {
            $('.modal-body').load('content.html', function () {
                ...
                document.getElementById("txtHorario").removeAttribute("readonly");//txtHorario
                document.getElementById("RegiondAltaMed").removeAttribute("disabled");
                ...
                <div class="form-body" style="padding-top:0px;">
                        ...
                        <div class="row">
                            <div class=" col-md-8">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="GestRegiId" class="form-control select2me ReloadDataTable">
                                            <option value="">Select...</option>
                                        </select>
                                    </div>
                                    <input type="hidden" id="Hidden1" name="permisoHidden1" runat="server"/>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableGesMedicos" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th style="width:10%; text-align: center; vertical-align:middle">CEDULA</th>
                                            <th style="width:25%; text-align: center; vertical-align:middle">NOMBRE</th>
                                            <th style="width:25%; text-align: center; vertical-align:middle">ESPECIALIDAD</th>
            ...
            <div class="modal-body">
                ...
                <div class=" col-md-12">
                     <div class="form-group">
                        ...
                        <div class="col-md-10">
                                   <select id="RegiondAltaMed" class="form-control select2me" disabled>
                                            <option value="">Select...</option>
                                   </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="control-label col-md-1">HORARIO:</label>
                        <div class="col-md-6">
                           <input type="text" id="txtHorario" class="form-control" name="txtHorario" value="" readonly/>
                        </div>
                    </div>
                     </div>
                    </div>
