<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerSolPendApro.aspx.cs" MasterPageFile="~/Views/Site.Master" Inherits="Portal.Views.Gestion.VerSolPendApro" %>


<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">SOLICITUDES PENDIENTES DE APROBAR | SOLUGLOB IKON</asp:Content>
...
<script src="/Assets/pages/scripts/SolCirugias/AprobacionSolCirugias.js"></script>
        <script>
            window.onload = function () {
                var DataColums = [{ data: "IDSolicitud" }, { data: "Hospital" }, { data: "Solicitud" }, { data: "Causa" }, { data: "Paciente" }, { data: "Episodio" }, { data: "Cedula" },
                    { data: "Medico" }, { data: "Especialidad" }, { data: "Accion" }];

                CargaVistPendApro("VerSolicitudesSinAprobar", $("#TableSolPendApro"),DataColums,9);
            }
        </script>
</asp:Content>
            ...
            <div class="portlet-body">
                <div class="form-body" style="padding-top:0px;">
                    ...
                    <div id="Contenedor" class="table-container" style="position:relative;">
                        ...
                        <table id="TableSolPendApro" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:10%; text-align: center; vertical-align:middle">TIP.SOL.</th>
                                    <th style="width:10%; text-align: center; vertical-align:middle">CAUSA</th>
                                    <th style="width:15%; text-align: center; vertical-align:middle">PACIENTE</th>
                                    <th style="width:5%; text-align: center; vertical-align:middle">EPISODIO</th>
