...
<asp:Content runat="server" ID="ContectPageLevelScripts" ContentPlaceHolderID="PageLevelScripts">
    ...
    <script src="/Assets/pages/scripts/SolCirugias/AprobacionSolCirugias.js"></script>
</asp:Content>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                           <div class=" col-md-12">
                            ...
                            <div class="col-md-4">
                                <center>
                                    <input type="button" id="btnCancelarAuto" name="btnCancelarAuto" class="btn red" value="No Aprobar" onclick="MuestraCancelacion();" />
                                    <input type="button" id="BtnAprobarAuto" name="BtnAprobarAuto" class="btn green" value="Aprobar" onclick="ActualizacionEstado(1);" /> 
                                </center>
                            </div>
                            <div class="col-md-4">
                            </div>
                        </div>
                                  <div class="form-group" id="divMotivoCancelacion" hidden="hidden">
                                    ...
                                    <div class="col-md-8">
                                      ...
                                      <div class="col-md-4">
                                          <div class="col-md-6">
                                          <input type="button" id="BtnAceptarCancelacion" name="BtnAceptarCancelacion" class="btn green" value="Aceptar Motivo" onclick="ActualizacionEstado(-1);" /> 
                                              </div>
                                          <div class="col-md-6">
                                          <input type="button" id="BtnCancelCan" name="BtnCancelCan" class="btn red" value="Regresar" onclick="OcultarCancelacion();" /> 
                                              </div>
                                      </div>
                                ...
                                <div class="form-group">
                                    <h1>Datos de Cirugia</h1>
                                     <div class="col-md-4">
                                        ...
                                        <div class="col-md-9">
                                          <input id="txtSolCiruApro" class="form-control" type="text" name="txtSolCiruApro" value="<%= NumSolicitud %>" readonly/> 
                                        </div>
                                    </div>
                                    <br />
                                    <h3>Paciente</h3>
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-9">
                                           <input id="txtHospitalSolPendApro" class="form-control" type="text" name="txtHospitalSolPendApro" value="" readonly/> 
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="control-label col-md-3">Cirugía:</label>
                                        <div class="col-md-9">
                                          <input id="txtCirSolPendApro" class="form-control" type="text" name="txtCirSolPendApro" value="" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="control-label col-md-3">Causa:</label>
                                        <div class="col-md-9">
                                           <input id="txtCausaSolPendApro" class="form-control" type="text" name="txtCausaSolPendApro" value="" readonly/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-7">
                                       ...
                                       <div class="col-md-9">
                                           <input id="txtPacienteSolPendApro" class="form-control" type="text" name="txtPacienteSolPendApro" value="" readonly/>
                                        </div>
                                    </div>
                                      <div class="col-md-3" id="EpisodioDiv">
                                        <label class="control-label col-md-3">Episodio:</label>
                                        <div class="col-md-9">
                                            <input id="txtEpisodioSolPendApro" class="form-control" type="text" name="txtEpisodioSolPendApro" value="" readonly/> 
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                               ...
                               <div class="form-group">
                                       <div class="col-md-6">
                                           <div id="ContenedorDiag" class="table-container" style="position:relative;">
                                                <div class="col-md-12">
                                                    <h4>Diagnostico</h4>
                                                    <table id="TableDiagSolPendApro" class="table table-striped table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="ContenedorCpt" class="table-container" style="position:relative;">
                                                <div class="col-md-12">
                                                    ...
                                                    <table id="TableCptSolPendApro" class="table table-striped table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                            ...
                            <div class="col-md-12" style="border-style: solid; border-width: .5px; border-color: gray">
                                <div class="form-group">
                                    <div class="col-md-2">
                                        ...
                                        <div class="col-md-9" >
                                            <input id="txtCedulaMedicoSolPendApro" class="form-control" type="text" name="txtCedulaMedicoSolPendApro" value="" readonly/> 
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="control-label col-md-3">Médico:</label>
                                        <div class="col-md-9" >
                                            <input id="txtNombreMedicoSolPendApro" class="form-control" type="text" name="txtNombreMedicoSolPendApro" value="" readonly/> 
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label col-md-3">Especialidad:</label>
                                        <div class="col-md-9" >
                                             <input id="txtEspecialidadSolPendApro" class="form-control" type="text" name="txtEspecialidadSolPendApro" value="" readonly/> 
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label col-md-3">Telefono:</label>
                                        <div class="col-md-9" >
                                            <input id="txtTelefonoSolPendApro" class="form-control" type="text" name="txtTelefonoSolPendApro" value="" readonly/> 
                                        </div>
                                    </div>
                                </div>
                           </div>
