<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="ConsultasAgendadas.aspx.cs" Inherits="Portal.Views.Interconsultas.ConsultasAgendadas" %>
<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">CONSULTAS AGENDADAS | SOLUGLOB IKON</asp:Content>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">CONSULTAS AGENDADAS</span>
                </div>
            </div>
                ...
                <div class="form-body" style="padding-top:0px;">
                        ...
                        <div class="row">
                            <div class=" col-md-8">
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange ReloadDataTable" data-date-format="mm/yyyy">
                                            <input type="text" id="dprFromConsulAgen" class="form-control" name="dprFromConsulAgen" value="<%=new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).ToString("MM/yyyy") %>">
                    ...
                    <div class="table-toolbar">  
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table id="TableConsultaAgendada" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
