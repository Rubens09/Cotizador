<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Master" CodeBehind="SolicitudCompra.aspx.cs" Inherits="Portal.Views.Compras.SolicitudCompra" %>

<asp:Content runat="server" ID="ContentTitle" ContentPlaceHolderID="Title">SOLICITUD DE COMPRA | GRUPO MEDRANO</asp:Content>
        ...
        <div class="portlet light portlet-fit portlet-form bordered" id="Entradas_Portlet">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red sbold uppercase">SOLICITUD DE COMPRA</span>
                </div>
            </div>
            <div class="portlet-body">
                <div class="form-body" style="padding-top:0px;">
                        ...
                        <div class="row">
                            <div class=" col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="EstatusSCId" class="form-control select2me ReloadDataTable">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="NoSolicitudId" class="form-control select2me ReloadDataTable">
                                            <option value="">Select...</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select id="UsuarioCreaId" class="form-control select2me ReloadDataTable">
                                            <option value="">Select...</option>
                                        </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="btn-group pull-right">
                                 ...
                                 <div class="col-md-6">
                                        <input type="button" class="btn red pull-right" value="Crear Solicitud" />
                                    </div>
                            </div>
                            </div>
                    ...
                    <div id="Contenedor" class="table-container" style="position:relative; padding:20px;">
                        ...
                        <table id="TableSolicitudesCompra" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th style="width:10%; text-align: center; vertical-align:middle">#SOLICITUD</th>
                                    <th style="width:40%; text-align: center; vertical-align:middle">DESCRIPCION</th>
                                    <th style="width:10%; text-align: center; vertical-align:middle">CREACION</th>
                                    <th style="width:20%; text-align: center; vertical-align:middle">ELABORO</th>
                ...
                <div class=" col-md-12">
                     <div class="form-group">
                          <label class="control-label col-md-1">REG:</label>
                                    <div class="col-md-11">
                                        <input type="text" id="regionVerIngre" class="form-control" name="regionVerIngre" readonly>
                                    </div>
                         </div>
