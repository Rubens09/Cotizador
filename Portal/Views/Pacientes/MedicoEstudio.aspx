...
<asp:Content runat="server" ID="ContectPageLevelScripts" ContentPlaceHolderID="PageLevelScripts">
    ...
    <script>
        window.onload = function () {
            ...
            CargaSelect("GetMedicos", $("#medicoId"), "medicoId");
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <%--  <div class="col-md-9">
                                        <select id="SelectRegionIngresoId" class="form-control select2me">
                                                <option value="">Select...</option>
                                        </select>
                                    </div>--%>
                                    <div class="col-md-9">
                                        <input id="RegionIngresoId" class="form-control" type="text" name="RegionIngresoId" value="<%= Region %>" readonly/> 
                                    </div>
                                 </div>
                            </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                <input id="pacienteIngresoId" class="form-control" type="text" name="pacienteIngresoId" value="<%= NomPac %>" readonly/> 
                                    <input type="hidden" id="AfiliacionPac" name ="AfiliacionPac" value="<%= Pacientes %>"/>
                                    <input type="hidden" id="IDRegionIngre" name ="IDRegionIngre" value="<%= IDRegion %>"/>
                                 </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                     <select id="medicoId" class="form-control select2me" onchange="CargaEspecialidad();">
                                            <option value="">Select...</option>
                                    </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-9">
                                 <select id="especialidadId" class="form-control select2me" onchange="CargaTelefono();">
                                            <option value="">Select...</option>
                                    </select>
                                 </div>
                            </div>
