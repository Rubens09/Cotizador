                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="dpRange" class="input-group date-picker input-daterange ReloadDataTable" data-date-format="dd/mm/yyyy">
                                            ...
                                            <input type="hidden" id="permisoHidden" name="permisoHidden" value="<%=permiso %>" />
                                            <input type="hidden" id="IDRegionHVerIngreso" name="IDRegionHVerIngreso" value="<%=IDRegion %>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div id="SelectRegionVerIngre">
                                        <select id="regionVerIngresoId" class="form-control select2me ReloadDataTable">
                                            <option value="">Select...</option>
                                        </select>
                                        </div>
                                        <div id="InputRegionVerIngre" hidden="hidden">
                                            <input type="Text" id="RegionHVerIngreso" name="RegionHVerIngreso" value="<%=Region %>" class="form-control" readonly/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
